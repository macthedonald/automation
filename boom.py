...
class StreamBoom():
    ...
    def run(self, window):
        ...
        self.wait.until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "body > div.cookieTipWrap > div > button"))).click()
        # play button
        self.wait.until(EC.presence_of_element_located(
            (By.CLASS_NAME, "btn_playAll"))).click()
    ...
    def replay(self, h, m, s):
        try:
            # pause
            self.wait.until(EC.presence_of_element_located(
                (By.CSS_SELECTOR, "body > footer > article.audioControl > button.audio_playBtn.audioUtils_btn_play"))).click()
    ...
    def countdown(self, h, m, s, window):
        ...
        while total_seconds > 0:
            ...
            total_seconds -= 1
        self.wait.until(EC.presence_of_element_located(
            (By.CSS_SELECTOR, "body > article.popHearMore.show > button.close"))).click()
